...
export function StockCard({ stock }: { stock: StockSummary }) {
  ...
  return (
    <article className="group relative flex flex-col min-h-[440px] rounded-[32px] border border-border-subtle bg-panel transition-all duration-300 ease-out hover:border-accent/50 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:-translate-y-2 hover:scale-[1.02]">
